                        ...
                        <div class="deals-row">
                            <div class="col-md-3 focus-grid"> 
                                <a href="products.html" class="wthree-btn"> 
                                    ...
                                    <h4 class="clrchg">Crear Pedido</h4> 
                                </a>
                            </div>
                            <div class="col-md-3 focus-grid"> 
                                <a href="pedidos/listar_pedido.php" class="wthree-btn"> 
                                    <div class="focus-image"><i class="fa fa-mobile"></i></div>
                                    <h4 class="clrchg">Gestion de Pedidos Actuales</h4> 
                                </a>
							</div>  
							<div class="col-md-3 focus-grid"> 
                                <a href="pedidos/listar_pedido_finalizado.php" class="wthree-btn"> 
                                    <div class="focus-image"><i class="fa fa-mobile"></i></div>
                                    <h4 class="clrchg">Pedidos Finalizados</h4> 
                                </a>
                            </div>                        
                            <div class="clearfix"> </div>
                        </div>  	

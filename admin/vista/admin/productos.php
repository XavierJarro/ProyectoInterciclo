...
<body>
	...
	<div>
            ...
            <div class="deals"> 
                    <div class="container"> 
                        <h3 class="w3ls-title">ADMINISTRACIÓN DE PRODUCTOS </h3>
                        <div class="deals-row">
                            <div class="col-md-3 focus-grid w3focus-grid-mdl"> 
                                <a href="producto/crear_producto.php" class="wthree-btn wthree4"> 
                                    <div class="focus-image"><i class="fa fa-asterisk"></i></div>
                                    <h4 class="clrchg">Crear Producto</h4>
                                </a>
                            </div>
                            <div class="col-md-3 focus-grid w3focus-grid-mdl"> 
                                <a href="producto/listar_producto.php" class="wthree-btn wthree4"> 
                                    <div class="focus-image"><i class="fa fa-asterisk"></i></div>
                                    <h4 class="clrchg">Gestion Producto</h4>
                                </a>
                            </div>
                            <div class="clearfix"> </div>
                        </div>  	

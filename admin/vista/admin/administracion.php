			...
			<div class="w3ls-header-right">
				<ul>
					...
					<?php
						...
						?>
						<a href="index.php" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i> 
                    ...
                    <div class="container"> 
                        ...
                        <div class="deals-row">
                            ...
                            <div class="col-md-3 focus-grid w3focus-grid-mdl"> 
                                <a href="facturas.php" class="wthree-btn wthree3"> 
                            ...
                            <div class="col-md-3 focus-grid"> 
							<a href="categoria.php" class="wthree-btn wthree3"> 
								<div class="focus-image"><i class="fa fa-home"></i></div>
								<h4 class="clrchg">Categoria de Productos</h4>
							</a>
						    </div>

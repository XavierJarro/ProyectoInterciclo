...
<body>
	...
	<div>
            ...
            <div class="deals"> 
                    <div class="container"> 
                        <h3 class="w3ls-title">ADMINISTRACIÓN DE CATEGORIAS </h3>
                        <div class="deals-row">
                            <div class="col-md-3 focus-grid"> 
                                <a href="categoria/crear_categoria.php" class="wthree-btn wthree"> 
                                    <div class="focus-image"><i class="fa fa-home"></i></div>
                                    <h4 class="clrchg">Crear Categoria</h4>
                                </a>
                            </div> 
                            <div class="col-md-3 focus-grid"> 
                                <a href="categoria/listar_categoria.php" class="wthree-btn wthree"> 
                                    <div class="focus-image"><i class="fa fa-home"></i></div>
                                    <h4 class="clrchg">Gestion Categorias</h4>
                                </a>
                            </div> 

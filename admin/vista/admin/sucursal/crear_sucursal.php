	    ...
	    <div>
			...
			<!--CREAR SUCURSAL -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Creacion de Sucursales</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../../controladores/admin/sucursal/crear_sucursal.php">

                                <label for="nombre">Nombre</label>
                                <input type="text" id="nombre" class="user" name="nombre" value="" placeholder="Ingrese el nombre de la sucursal">

                                <label for="direccion">Dirección</label>
								<input type="text" id="direccion" class="user" name="direccion" value="" placeholder="Ingrese la direccion de la sucursal">
								
								<label for="ciudad">Ciudad</label>
                                <input type="text" id="ciudad" class="user" name="ciudad" value="" placeholder="Ingrese la ciudad de la sucursal">

								 <input type="submit" id="crear" name="crear" value="Crear Sucursal">

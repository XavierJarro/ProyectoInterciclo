...
<!-- //font-awesome icons -->
<!-- js -->
<script src="../../../../js/pagina/pagina/pagina/jquery-2.2.3.min.js"></script> 
<!-- //js --> 
<!-- web-fonts -->
...
<!-- web-fonts --> 
<script src="../../js/pagina/pagina/owl.carousel.js"></script>  
<script src="../../../../js/pagina/pagina/jquery-scrolltofixed-min.js" type="text/javascript"></script>
<!-- start-smooth-scrolling -->
<script type="text/javascript" src="../../../../js/pagina/pagina/move-top.js"></script>
<script type="text/javascript" src="../../../../js/pagina/pagina/easing.js"></script>	
	    ...
	    <div>
			...
			<!--MIS DATOS -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Eliminación de Productos</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../../controladores/admin/producto/eliminar_producto.php" enctype="multipart/form-data">
                                
                            <input type="hidden" id="codigo" name="codigo" value="<?php echo $codigo ?>" />      

                                <label for="cedula">Nombre</label>
                                <input type="text" id="nombre" class="user" name="nombre" value="<?php echo $row['pro_nombre'] ?>" disabled>

                                <label for="descripcion">Desripción</label>
                                <input type="text" id="descripcion" class="user" name="descripcion" value="<?php echo $row['pro_descripcion'] ?>" disabled>

                                <label for="precio">Precio</label>
                                <input type="text" id="precio" class="user" name="precio" value="<?php echo $row['pro_precio'] ?>" disabled>

                                <label for="stock">Stock</label>
                                <input type="text" id="stock" class="user" name="stock" value="<?php echo $row['pro_stock'] ?>" disabled>

                                <!--<label for="cedula">Categoria</label>
                                <input type="text" id="categoria" class="user" name="categoria" value="<?php echo $row['pro_categoria'] ?>" disabled>-->

                                <label for="cedula">Imagen</label>
                                <br>
                                ...
                                <input type="submit" id="eliminar" name="eliminar" value="Eliminar Producto"> 

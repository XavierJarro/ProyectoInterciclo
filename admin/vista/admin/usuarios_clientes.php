...
<body>
	...
	<div>
            ...
            <div class="deals"> 
                    <div class="container"> 
                        <h3 class="w3ls-title">ADMINISTRACIÓN DE CLIENTES O USUARIOS </h3>
                        <div class="deals-row">
                            <div class="col-md-3 focus-grid"> 
                                <a href="usuario/crear_usuario.php" class="wthree-btn wthree2"> 
                                    <div class="focus-image"><i class="fa fa-wheelchair"></i></div>
                                    <h4 class="clrchg">Crear Clientes o Usuarios</h4>
                                </a>
                            </div>      
                            <div class="col-md-3 focus-grid"> 
                                <a href="usuario/listar_usuario.php" class="wthree-btn wthree2"> 
                                    <div class="focus-image"><i class="fa fa-wheelchair"></i></div>
                                    <h4 class="clrchg">Listar Clientes o Usuarios</h4>
                                </a>
                            </div>             
                            <div class="clearfix"> </div>
                        </div>  	

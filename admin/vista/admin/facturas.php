...
<body>
	...
	<div>
            ...
            <div class="deals"> 
                    <div class="container"> 
                        <h3 class="w3ls-title">ADMINISTRACIÓN DE PEDIDOS </h3>
                        <div class="deals-row">
                            <div class="col-md-3 focus-grid w3focus-grid-mdl"> 
                                <a href="facturas/listar_factura_usuario.php" class="wthree-btn wthree3"> 
                                    <div class="focus-image"><i class="fa fa-book"></i></div>
                                    <h4 class="clrchg">Gestion de Facturas</h4> 
                                </a>
							</div> 
							<div class="col-md-3 focus-grid w3focus-grid-mdl"> 
                                <a href="facturas/listar_factura_sucursal.php" class="wthree-btn wthree3"> 
                                    <div class="focus-image"><i class="fa fa-book"></i></div>
                                    <h4 class="clrchg">Gestion de Facturas por Sucursal</h4> 
                                </a>
                            </div>                     
                            <div class="clearfix"> </div>
                        </div>  	

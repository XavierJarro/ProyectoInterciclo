...
<body>
	...
	<div>
		...
		<!--CREAR SUCURSAL -->
		<table id="tablaDatos">
			<caption>Gestion de Fcaturas</caption>
			<tr>
                <th>Imagen</th>
                <th>Producto</th>
				<th>Cliente</th>
			...
			$sql = "SELECT * FROM factura_cabecera WHERE facab_eliminada = 'N'";
			$result = $conn->query($sql);
				...
				while ($row = $result->fetch_assoc()) {
                    ...
                    if($result2 != null){
                        ...
                        if($result3 != null){
                            ...
                            echo "   <td>". "<a href = '../../controladores/usuario/pedidos/eliminar_proped.php?codigoPedido=".$row['ped_codigo']."'>"."Estado del Pedido</a>"."</td>";
                            echo "   <td>". "<a href = '../../controladores/usuario/pedidos/eliminar_proped.php?codigoPedido=".$row['ped_codigo']."'>"."Eliminar Pedido</a>"."</td>";
                            echo "   <td>". "<a href = '../../controladores/usuario/pedidos/eliminar_proped.php?codigoPedido=".$row['ped_codigo']."'>"."Actualizar Pedido</a>"."</td>";
                            echo "</tr>";
                        }else{
                            echo "<tr>";

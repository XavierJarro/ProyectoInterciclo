			...
			if ($result->num_rows > 0) {
				while ($row = $result->fetch_assoc()) {
                    $codSuc = $row['facab_suc_codigo'];
                        ...
                        $sql2 = "SELECT * FROM sucursal WHERE suc_codigo = '$codSuc' AND suc_eliminada = 'N'";
                        ...
                        if($result2 != null){
                            ...
                            echo "   <td>" . $row2['suc_nombre']. "</td>";
                            echo "   <td>". "<a href = 'detalle_factura_sucursal.php?codigoCabecera=".$row['facab_codigo']."'>"."Detalles de Factura</a>"."</td>";

				...
				while ($row = $result->fetch_assoc()) {
                    ...
                    if($result2 != null){
                        ...
                        if($result3 != null){
                            ...
                            echo "   <td>". "<a href = 'detalle_factura.php?codigoCabecera=".$row['facab_codigo']."'>"."Detalles de Factura</a>"."</td>";
                            echo "   <td>". "<a href = '../../../controladores/admin/factura/anular_factura.php?codigocabecera=".$row['facab_codigo']."'>"."Anular Factura</a>"."</td>";
                            echo "</tr>";
                        }else{
                            echo "<tr>";

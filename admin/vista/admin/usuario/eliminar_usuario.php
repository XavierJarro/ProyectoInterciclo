	    ...
	    <div>
			...
			<!--MIS DATOS -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Eliminar de Datos del Usuario</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
							<form  method="POST" action="../../../controladores/admin/usuario/eliminar_usuario.php">
							...
							<input type="hidden" id="codigo" name="codigo" value="<?php echo $codigo ?>" /> 
								...
								$conn->close();
								 ...
								 <input type="submit" id="actualizar" name="actualizar" value="Eliminar Datos">

...
<script src="../../../../js/buscar_usuario.js" type="text/javascript"></script>
</head>
<body>
	<script>
	...
	<div class="header">
        ...
        <input autofocus type="text" id="buscarUsuario" name="buscarUsuario" value="" placeholder="Buscar Usuario" onkeyup="buscarUsuario()"/>

			<!--CREAR SUCURSAL -->
            <table id="tablaDatos">
                <caption>Gestion de Usuarios(Clientes)</caption>
                <tr>
                    <th>Cedula</th>
                    <th>Nombres</th>
                    <th>Apellidos</th>

	    ...
	    <div>
			...
			<!--MIS DATOS -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Actualización de Datos del Usuario</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../../controladores/admin/usuario/actualizar_usuario.php">

							<input type="hidden" id="codigo" name="codigo" value="<?php echo $codigo ?>" /> 

                                <label for="cedula">Cedula</label>
                                <input type="text" id="cedula" class="user" name="cedula" placeholder="cedula" value="<?php echo $row['usu_cedula'] ?>" >

                                <label for="cedula">Nombres</label>
                                <input type="text" id="nombres" class="user" name="nombres" placeholder="nombres" value="<?php echo $row['usu_nombres'] ?>" >

                                <label for="cedula">Apellidos</label>
                                <input type="text" id="apellidos" class="user" name="apellidos" placeholder="apellidos" value="<?php echo $row['usu_apellidos'] ?>" >

                                <label for="cedula">Dirección</label>
                                <input type="text" id="direccion" class="user" name="direccion" placeholder="dirección" value="<?php echo $row['usu_direccion'] ?>" >

                                <label for="cedula">Telefono</label>
                                <input type="text" id="telefono" class="user" name="telefono" placeholder="telefono" value=" <?php echo $row['usu_telefono'] ?>" >

                                <label for="cedula">Correo Electrónico</label>
                                <input type="text" id="correo" class="user" name="correo" placeholder="correo electrónico" value="<?php echo $row['usu_correo'] ?>" >

                                <label for="cedula">Fecha de Nacimiento</label>
                                <input type="text" id="fechanacimiento" class="user" name="fechanacimiento" placeholder="fecha de nacimiento" value="<?php echo $row['usu_fecha_nacimiento'] ?>" > <br>
								...
								$conn->close();
								 ...
								 <input type="submit" id="actualizar" name="actualizar" value="Actualización de Datos">

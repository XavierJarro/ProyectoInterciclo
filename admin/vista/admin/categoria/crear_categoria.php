			...
			<div class="w3ls-header-right">
				<ul>
					<li class="dropdown head-dpdn">
						...
						?>
						<a href="../administracion.php" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i> 
                        Administración del Sitio<span class="caret"></span></a>
	    ...
	    <div>
			...
			<!--CREAR SUCURSAL -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Creacion de Categoria</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../../controladores/admin/categoria/crear_categoria.php">

                                <label for="nombre">Nombre</label>
                                <input type="text" id="nombre" class="user" name="nombre" value="" placeholder="Ingrese el nombre de la sucursal">

								 <input type="submit" id="crear" name="crear" value="Crear Categoria">

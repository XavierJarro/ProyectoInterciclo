...
<body>
	...
	<div class="header">
	    ...
	    <div>
                        ...
                        $sql= "SELECT * FROM categoria WHERE cate_codigo = '$codigo' AND cate_eliminada = 'N'";
                            $result= $conn->query($sql);
                            if($result->num_rows> 0) {
                                while($row= $result->fetch_assoc()) {
                        ?>
			<!--MIS DATOS -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Actualización de Categoria</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../../controladores/admin/categoria/actualizar_categoria.php">
                                
                            <input type="hidden" id="codigo" name="codigo" value="<?php echo $codigo ?>" />      

                                <label for="cedula">Nombre</label>
                                <input type="text" id="nombre" class="user" name="nombre" value="<?php echo $row['cate_nombre'] ?>">

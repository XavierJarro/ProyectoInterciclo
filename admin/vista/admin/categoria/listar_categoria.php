...
<body>
	...
	<div class="header">
	    ...
	    <div>
			...
			<!--CREAR SUCURSAL -->
            <table id="tablaDatos">
                <caption>Gestion de Categorias</caption>
                <tr>
                    <th>Nombre</th>
                    <th>Eliminar</th>
                    <th>Actualizar</th>
                ...
                <?php
                    ...
                    $sql= "SELECT * FROM categoria WHERE cate_eliminada = 'N'"; 
                    $result= $conn->query($sql);
                    ...
                    if($result->num_rows> 0) {
                        while($row= $result->fetch_assoc()) {
                            ...
                            echo "<tr>";
                            echo "   <td>". $nombre. "</td>";
                            echo "   <td>". "<a href = '../../../controladores/admin/categoria/eliminar_categoria.php?codigo=".$row['cate_codigo']."'>"."eliminar</a>"."</td>";
                            echo "   <td>". "<a href = 'actualizar_categoria.php?codigo=".$row['cate_codigo']."'>"."actualizar</a>"."</td>";
                            echo"</tr>";
                        }
                    } else{
                        echo"<tr>";
                        echo"   <td colspan='7'> No existen categorias de productos</td>";
                        echo"</tr>";
                    }

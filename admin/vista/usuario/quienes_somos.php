...
<body>
    ...
    <div class="header-two">
            ...
            <div class="header-cart">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="figure">
                            <img id="imag2" class="imag2" src="data:image/jpg;base64,<?php echo base64_encode($row['usu_imagen']) ?>" alt="imagenPerfil" width="90" height="90">
                        <?php
                    }
                }
                ?>
        ...
        <div>
            ...
            <h1>
                <p>Supermarket "Fabiola surge de la idea de tener un supermarker online con los mejores precios del en el
                    mercado y ademas
                    ofreciendo producto de calidad"</p>
            </h1>
        </div>

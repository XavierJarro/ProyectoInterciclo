...
<body>
    ...
    <div class="header">
        ...
        <div class="figure">
            <img id="imag4" class="imag4" src="data:image/jpg;base64,<?php echo base64_encode($row['usu_imagen']) ?>" alt="imagenPerfil" width="90" height="90">
            <?php
                }
            }
        ?>
            ...
            <div id="examinar">
                <form name="MiForm" method="POST" action="../../controladores/usuario/cargar_imagen.php" enctype="multipart/form-data">
                    <input type="file" id="fotoPerfil" name="fotoPerfil">
                    <input type="submit" name="cargar" id="cargar" value="Actualizar Foto de Perfil">
                </form>
            </div>
        </div>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="login-page">
                    <div class="container">
                        <h3 class="w3ls-title w3ls-title1">Mis datos</h3>
                        <div class="login-body">
                            ...
                            <form method="POST" action="#">
                                ...
                                <input type="text" id="fechanacimiento" class="user" name="fechanacimiento" placeholder="fecha de nacimiento" value="<?php echo $row['usu_fecha_nacimiento'] ?>" disabled>
                    ...
                    ?>
                        ...
                        <div class="tres">
                            <a href="actualizar_datos.php">Actualizar Datos</a> <br> <br>
                            <a href="cambio_contrasena.php">Cambiar Contraseña</a> <br>
                        </div>

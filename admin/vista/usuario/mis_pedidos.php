...
<body>
					...
					<li class="dropdown head-dpdn">
						...
						if ($result->num_rows > 0) {
							while ($row4 = $result->fetch_assoc()) {
								?>
								<a href="mi_cuenta.php" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i>
									MI_CUENTA<span class="caret"></span></a>
	...
	<div>
		...
		<table id="tablaDatos">
			...
			$sql = "SELECT * FROM pedidos WHERE ped_eliminado = 'N' AND ped_cod_usu = $codigoin";
			$result = $conn->query($sql);

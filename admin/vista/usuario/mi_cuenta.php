...
<body>
	...
	<div>
			...
			<div class="deals"> 
				<div class="container"> 
					<h3 class="w3ls-title">TU CUENTA </h3>
					<div class="deals-row">
						<div class="col-md-3 focus-grid"> 
							<a href="mis_pedidos.php" class="wthree-btn"> 
								<div class="focus-image"><i class="fa fa-mobile"></i></div>
								<h4 class="clrchg">Tus pedidos</h4> 
							</a>
						</div>
						<div class="col-md-3 focus-grid"> 
							<a href="datos_usuario.php" class="wthree-btn wthree1"> 
								<div class="focus-image"><i class="fa fa-laptop"></i></div>
								<h4 class="clrchg"> Inicio de Sesión y Seguridad</h4> 
							</a>
						</div> 
						<div class="col-md-3 focus-grid"> 
							<a href="mis_facturas.php" class="wthree-btn wthree2"> 
								<div class="focus-image"><i class="fa fa-wheelchair"></i></div>
								<h4 class="clrchg">Mis facturas</h4>
							</a>
						</div> 
						<div class="clearfix"> </div>
					</div>  	

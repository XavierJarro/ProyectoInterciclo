...
<body>
	...
	<div class="header">
        ...
        <div class="figure">
            <img id="imag5" class="imag5" src="data:image/jpg;base64,<?php echo base64_encode($row['usu_imagen']) ?>" alt="imagenPerfil" width="90" height="90">
            <?php
                }
            }
            $conn->close();
	...
	<div>
		<!--CREAR SUCURSAL -->
		<table id="tablaDatos">
			<caption>PRODUCTOS QUE AS AÑADIDO AL CARRITO</caption>
			<tr>
                <th>Imagen</th>
				<th>Producto</th>
				<th>Precio</th>
			...
			if ($result->num_rows > 0) {
				while ($row = $result->fetch_assoc()) {
                    ...
                    if($result2 != null){
						...
						echo "   <td>" . $row2['pro_precio'] . "</td>";
						echo "   <td>" . $row['ped_cantidad'] . "</td>";
                        echo "   <td>". "<a href = '../../controladores/usuario/pedidos/eliminar_proped.php?codigoPedido=".$row['ped_codigo']."'>"."Eliminar del Carrito</a>"."</td>";
                        echo "</tr>";
                    }else {
                        echo "<tr>";
                        echo "   <td colspan='7'> No tienes Productos en tu carrito </td>";
                        echo "</tr>";
                    }	
				}
			} else {
		...
		<h3> <p style="text-align: center"><a href="factura_pedido.php">PROCEDER CON LA COMPRA DE TU PEDIDO</a></p></h3>

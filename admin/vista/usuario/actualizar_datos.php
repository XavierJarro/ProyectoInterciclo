	    ...
	    <div>
			...
			<!--MIS DATOS -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Actualización de Datos</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../controladores/usuario/actualizar_datos.php">
                            ...
                            <input type="hidden" id="codigo" name="codigo" value="<?php echo $codigo ?>" /> 
                                ...
                                <input type="text" id="fechanacimiento" class="user" name="fechanacimiento" placeholder="fecha de nacimiento" value="<?php echo $row['usu_fecha_nacimiento'] ?>" >

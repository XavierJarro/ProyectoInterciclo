...
<body>
	...
	<div class="header">
	    ...
	    <div>
                        ...
                        $codigoped = $_GET['codigoPedido'];

                        /*$codcategoria = $GET['codigocategoria'];*/

                        $sql= "SELECT * FROM pedidos WHERE ped_codigo = '$codigoped' AND ped_eliminado = 'N'";
                            $result= $conn->query($sql);
                            if($result->num_rows> 0) {
                                while($row= $result->fetch_assoc()) {
			...
			<!--MIS DATOS -->
			    <div class="login-page">
                    <div class="container"> 
                        <h3 class="w3ls-title w3ls-title1">Actualización de mi Pedido</h3>  
                        <div class="login-body">
                            <!--DATOS DEL USUARIO =========================== -->
                            <form  method="POST" action="../../controladores/usuario/pedidos/actualizar_pedido.php" enctype="multipart/form-data">
                                
                            <input type="hidden" id="codigo" name="codigo" value="<?php echo $codigoped ?>" />      
